...
const AddTaskModal: React.FC<AddTaskModalProps> = ({ isOpen, onClose, onSubmit, users, plots, inventory }) => {
    ...
    const handleAddInventoryItem = () => {
        setInventoryConsumed([...inventoryConsumed, { inventoryId: inventory[0]?.id || '', quantityUsed: 0 }]);
    };
    ...
    const handleInventoryItemChange = (index: number, field: 'inventoryId' | 'quantityUsed', value: string | number) => {
        const updated = [...inventoryConsumed];
        if (field === 'inventoryId') {
            updated[index].inventoryId = value as string;
        } else {
                                ...
                                <div key={index} className="flex gap-2 items-end">
                                    <div className="flex-1">
                                        ...
                                        <select
                                            ...
                                            onChange={e => handleInventoryItemChange(index, 'inventoryId', e.target.value)}
                                    ...
                                    <div className="w-32">
                                        ...
                                        <input
                                            ...
                                            onChange={e => handleInventoryItemChange(index, 'quantityUsed', Number(e.target.value))}
                                            className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-gray-900 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                            min="0"
                                        />
                                    </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select id="plot-filter" value={selectedPlot} onChange={e => setSelectedPlot(e.target.value)} className="w-full px-3 py-1.5 border border-gray-300 rounded-md shadow-sm bg-white text-gray-900 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <select id="assignee-filter" value={selectedAssignee} onChange={e => setSelectedAssignee(e.target.value)} className="w-full px-3 py-1.5 border border-gray-300 rounded-md shadow-sm bg-white text-gray-900 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <select id="status-filter" value={selectedStatus} onChange={e => setSelectedStatus(e.target.value)} className="w-full px-3 py-1.5 border border-gray-300 rounded-md shadow-sm bg-white text-gray-900 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <select id="category-filter" value={selectedCategory} onChange={e => setSelectedCategory(e.target.value)} className="w-full px-3 py-1.5 border border-gray-300 rounded-md shadow-sm bg-white text-gray-900 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-1.5 border border-gray-300 rounded-md shadow-sm bg-white text-gray-900 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                            />
                        </div>
                        <div>
